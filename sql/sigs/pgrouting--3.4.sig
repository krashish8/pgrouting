...
_pgr_withpointsvia(text,text,anyarray,boolean,character,boolean,boolean,boolean)
pgr_withpointsvia(text,text,anyarray,boolean,character,boolean,boolean,boolean)
